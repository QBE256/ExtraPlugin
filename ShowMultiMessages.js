...
(function(){
	var _MessageShowEventCommand__completeEventCommandMemberData = MessageShowEventCommand._completeEventCommandMemberData;
	...
	FaceView.isMultiShowMessageSwitchOn = function() {
		var index = root.getMetaSession().getGlobalSwitchTable().getSwitchIndexFromId(MultiShowMessageGlobalSwitchId);
		return root.getMetaSession().getGlobalSwitchTable().isSwitchOn(index);	
	};
